...
Step 1 - Upload Grimoire Codex to any LLM - PDF seemed to work best

Step 2 - enter grimoire Prompt - with intent

Step 3 - wait a couple of minutes (literally)

Step 4 - refine to how you wish to go forward i.e have demos made, simulations, change to
python, XtexT etc from this method.
